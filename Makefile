...
$(B_DIR)/$(O_OBJ):
	$(MAKE) -C $(O_DIR) OUTPUT=$@ E_CFLAGS="$(STD_INCS) $(E_CFLAGS) $(LNX_INCS)"

$(B_DIR)/$(S_OBJ):
	$(MAKE) -C $(S_DIR) OUTPUT=$@ E_CFLAGS="$(STD_INCS) $(E_CFLAGS) $(LNX_INCS)"

$(B_DIR)/$(X_OBJ):
	$(MAKE) -C $(X_DIR) OUTPUT=$@ E_CFLAGS="$(STD_INCS) $(E_CFLAGS) $(STL_INCS)"
